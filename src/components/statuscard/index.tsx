...
function StatusCard({number, type, data}: CardProps){
	return(
		...
		{type === "CONTRATANTES" && number === 1 ? <img src={Contratantes1}></img> : ''}
		{type === "CONTRATANTES" && number === 2 ? <img src={Contratantes2}></img> : ''}
		{type === "CONTRATANTES" && number === 3 ? <img src={Contratantes3}></img> : ''}
		<span>{data}</span>
		</S.Body>
		</>
	)
