...
<Modal show={confirmationShow} onHide={handleConfirmationClose} centered  size="xl">
      
      <Modal.Body>
         
            <S.ModalHeader>
             <div> <h2>Confirme os dados da notificação</h2>
              
            <button  onClick={handleConfirmationClose}>
          X
        </button></div>
        <h4>Destinatário: <span>CONTRATANTE</span></h4>
            </S.ModalHeader>
          <S.ModalBody>
...
<S.ContainerScroll>
            ...
            <S.ModalFooter>
              <h2>Esse procedimento <span>não pode ser desfeito</span></h2>
              <S.CancelButton onClick={handleConfirmationClose}>Cancelar</S.CancelButton>
              <S.ConfirmButton onClick={() => {handleConfirmationClose(); handleConfirmatedShow()}}>Confirmar e enviar notificação</S.ConfirmButton>
        ...
        <S.ContainerAll>
          ...
          <S.ContainerContent>
            <S.ContainerScroll>
              ...
              <S.ButtonCustom onClick={() => handleConfirmationShow()}>Salvar</S.ButtonCustom>
